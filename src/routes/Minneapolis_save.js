  ...
  return (
    <div className="mn">
      ...
      <div className="front_poster">
        <img
          src={
            "https://ourmsacodingfolder.s3.us-east-2.amazonaws.com/minnesota_main_science_poster.jpg"
          }
          alt=""
        />
        <div className="textDiv">
          ...
          <p className="text time-stuff dates">7/08-8/30 (M to F)</p>
          <p className="text time-stuff time">8:30 AM - 4:30 PM</p>
          <p className="text time-stuff location">
